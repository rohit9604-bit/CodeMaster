	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'glow-amber-lg': '0 0 30px rgba(245,158,11,0.25), 0 0 60px rgba(245,158,11,0.1)',
				'glow-emerald': '0 0 20px rgba(16,185,129,0.15), 0 0 40px rgba(16,185,129,0.05)',
				'glow-soft': '0 8px 32px rgba(0,0,0,0.3)',
				'glass': '0 0 0 1px rgba(63,63,70,0.1), 0 8px 32px rgba(0,0,0,0.3)',
				'glass-hover': '0 0 0 1px rgba(245,158,11,0.1), 0 16px 48px rgba(0,0,0,0.4)',
			},
			borderRadius: {
				lg: 'var(--radius)',
